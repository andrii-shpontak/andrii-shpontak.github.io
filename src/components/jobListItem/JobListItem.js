...
const JobListItem = ({ address, benefits, createdAt, description, email, empoyment_type, id, location, name, phone, pictures, salary, title, updatedAt, deleteItem }) => {
    ...
    return (
        <div className='card_item'>
            ...
            <div className='card_update'>
                <div className="trashIcon"><DeleteIcon onClick={() => onDelete(id)}/></div>
                Founded in {createdAt.slice(0, 4)}
            </div>
